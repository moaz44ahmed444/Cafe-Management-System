...
public class ProductServiceImpl implements ProductService {
    ...
    private boolean validateProductMap(Map<String, String> requestMap, boolean validateId) {
        if (requestMap.containsKey("name") || requestMap.containsKey("status")){
        ...
        try {
            if (jwtFilter.isAdmin()){
                if (validateProductMap(requestMap, true)){
                    ...
                    else return CafeUtils.getResponseEntity("Product ID Doesn't Exist .", HttpStatus.OK);
                }else {
                    return CafeUtils.getResponseEntity(CafeConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
                }
            }else {
    ...
    public ResponseEntity<String> deleteProduct(Integer id) {
        try{
            if (jwtFilter.isAdmin()){
                ...
                System.out.println("whhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhy");
            ...
            if (jwtFilter.isAdmin()){
                if (validateProductMap(requestMap, true)){
                    ...
                    if (!optional.isEmpty()){
                        ...
                        return CafeUtils.getResponseEntity("ProductStatus Updated Successfully", HttpStatus.OK);
                    }
